...
@foreach ($role_list as $role)
    ...
    <div class="col-md-4">
        ...
        @include('adminPanel.partials.checklist', ['list' => $user->roles, 'origin' => $role])
        >
        ...
        <div class="form-group row">
            ...
            <div class="col-md-10">
            @include('adminPanel.permissions.partials.list', ['permission_list' => $role->permissions, 'user' => $user])
            </div>
        </div>
